        ...
        <div className="min-h-screen bg-slate-950 font-sans text-slate-100 flex flex-col md:flex-row">
            ...
            <div className="flex-1 p-6 md:p-10 overflow-y-auto">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                    ...
                    <button 
                        onClick={() => setEditingFirm({ plan: 'basic', isActive: true, licenseKey: '', adminName: '', adminPin: '', licenseStartDate: Date.now(), licenseEndDate: Date.now() + 30 * 24 * 60 * 60 * 1000, modules: AVAILABLE_MODULES.map(m => m.id) })}
                    ...
                    <div className="bg-slate-900/50 border border-white/10 p-6 rounded-2xl mb-8 animate-in slide-in-from-top-4 fade-in duration-200">
                        ...
                        <form onSubmit={handleSaveFirm} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select value={editingFirm.plan} onChange={e => setEditingFirm({...editingFirm, plan: e.target.value as any})} className="w-full bg-slate-950 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-purple-500">
